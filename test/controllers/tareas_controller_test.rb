...
class TareasControllerTest < ActionController::TestCase
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post :create, tarea: { date: @tarea.date, description: @tarea.description, name: @tarea.name, time: @tarea.time }
    end
  ...
  test "should update tarea" do
    patch :update, id: @tarea, tarea: { date: @tarea.date, description: @tarea.description, name: @tarea.name, time: @tarea.time }
    assert_redirected_to tarea_path(assigns(:tarea))
  end
